...
class AnswerSheetTests(TestCase):
    ...
    def test_answer_sheet_template_recovers_stale_realtime_connections(self):
        ...
        self.assertContains(response, "SOCKET_WATCHDOG_INTERVAL_MS")
        ...
        self.assertContains(response, "startAnswerSheetSocketWatchdog();")
        ...
        self.assertIn("type: 'answer_sheet_sync'", response_html)
        self.assertIn("applyAnswerSheetSyncPayload(data.payload || {}, {", response_html)
        self.assertIn("reloadOnIdentityMismatch: false", response_html)
